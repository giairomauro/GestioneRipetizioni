				...
				<aside id="sidebar" class="column-left">
					...
					<nav id="mainnav">
						<ul>
							...
							<li><a href="http://eserciz.samtinfo.ch/home/aggiungiMateria/<?php echo $mail ?>">Aggiungi/Rimuovi materia</a></li>
							<li class="selected-item"><a href="http://eserciz.samtinfo.ch/home/aggiungiCategoria/<?php echo $mail ?>">Aggiungi categoria</a></li>
							<li><a href="http://eserciz.samtinfo.ch/logout/">Disconetti</a></li>
						</ul>
					</nav>
				</aside>